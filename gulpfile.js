...
gulp.task('watch', ['supervision'], function() {
  ...
  var config = {
    files: [paths.scripts.destination, paths.templates.destination, paths.partials.destination, paths.media.destination, paths.index.destination, './build/client/bundle.js'],
    port: 7678,
